...
class PerformanceAlertSummaryViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def list(self, request):
        ...
        for summary in summaries:
            ...
            for (key, alerts) in [('alerts', summary.generated_alerts),
                                  ('related_alerts', summary.related_alerts)]:
                for alert in alerts.all():
                    alertdict = {
                        ...
                        'initial_value': round(alert.initial_value, 2),
                    ...
                    summarydict[key].append(alertdict)
